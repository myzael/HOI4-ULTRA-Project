...
NGame = {
	...
	GAME_SPEED_SECONDS = { 1.6, 0.8, 0.4, 0.2, 0.0 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
	...
	TRADE_ROUTE_RECALCULATE_FREQUENCY_DAYS = 15, 	--was 30 -- Max recalculation time for all trade routes (0 means we do not recalucate prediodically trade routes)
	COMBAT_LOG_MAX_MONTHS = 18,
	MESSAGE_TIMEOUT_DAYS = 30,--was 60 				-- Useful if running the handsoff game. The popup messages that doesn't require the player respond will automatically hide after some timeout.
...
NDiplomacy = {
	...
	NUM_DAYS_TO_ENABLE_REINVITE_KICKED_NATIONS = 365,			-- Number of days before being able to re invite a kicked nation to your faction
	...
	BASE_SEND_ATTACHE_COST = 25, --was 100 --Political power cost to send attache
	BASE_SEND_ATTACHE_CP_COST = 25, --was 50.0 --Command Power sent attache usage cost
	BASE_GENERATE_WARGOAL_DAILY_PP = 0.8,--was 0.2	-- Daily pp cost for generation of wargoals
	WARGOAL_VERSUS_MAJOR_AT_WAR_REDUCTION = -0.4,--was -0.75 	-- reduction of pp cost for wargoal vs major at war.
	WARGOAL_WORLD_TENSION_REDUCTION = -0.7,--was -0.5			-- Reduction of pp cost for wargoal at 100% world tension, scales linearly
	WARGOAL_JUSTIFY_TENSION_FROM_PRODUCTION = 20.0,	--was 30 	-- Base value scaled by production capacity of country compared to biggest country
	...
	BASE_BOOST_PARTY_POPULARITY_DAILY_DRIFT = 0.03, --was 0.1 --Daily amount of popularity that will be added by the activity.
	...
	TROOP_FEAR = 5, --was 1 --Impact on troops on borders when deciding how willing a nation is to trade
	...
	VOLUNTEERS_PER_TARGET_PROVINCE = 0.00,--was 0.05			-- Each province owned by the target country contributes this amount of volunteers to the limit.
	VOLUNTEERS_PER_COUNTRY_ARMY = 0.00,--was 0.05				-- Each army unit owned by the source country contributes this amount of volunteers to the limit.
	...
	VOLUNTEERS_DIVISIONS_REQUIRED = 0,--was 30				-- This many divisons are required for the country to be able to send volunteers.
	...
	TENSION_CB_WAR = 2.5,--was 7					-- Amount of tension generated by a war with a CB
	...
	TENSION_PUPPET = 1.5,							--was 1.25	-- Amount of tension generated by puppeting (per state)
	TENSION_FORCE_GOVERNMENT = 0.75,                -- Amount of tension generated by forcing government (per state)
	TENSION_VOLUNTEER_FORCE_DIVISION = 0.5,--was 0.2-- Amount of tension generated for each sent division
	...
	TENSION_GUARANTEE = -5,
	TENSION_FACTION_JOIN = 0,--was 4						
	TENSION_JOIN_ATTACKER = 0,--was 2				-- scale of the amount of tension added when country joins attacker side
	...
	TENSION_CAPITULATE = 0.50,--was 0.4 			-- Scale of the amount of tension created by a countries capitulation.
	...
	RESOURCE_SENT_AUTONOMY_DAILY_FACTOR = 0.0,--was 0.005	-- If puppet provides resources to its master they increasy their autonomy by the resources factored by this
	WAR_SCORE_AUTONOMY_BASE = 0.0,					-- Value added if any war score is contributed by puppet
	WAR_SCORE_AUTONOMY_FACTOR = 0.003,--was 0.6				-- If puppet generates war score it get a boost to independence
	LL_TO_OVERLORD_AUTONOMY_DAILY_BASE = 0.002,--was 0.0	-- If puppet lend leases equipment to overlord of at least same tech level as they have, they gain autonomy
	...
	LL_TO_PUPPET_AUTONOMY_DAILY_FACTOR = -0.002,--was -0.01	-- If overlord lend leases equipment to puppet of higher tech level as they have, puppet losses autonomy
	AUTONOMY_FREEDOM_FROM_CAPITULATE = 0.3,--was 0.5        -- if overlord capitulate you get this
	...
	AUTONOMY_LEVEL_CHANGE_PP_COST_BASE = 500.0, --was 50.0 --Base cost of changing level of autonomy
	AUTONOMY_LEVEL_CHANGE_PP_ANNEX = 1000, --was 300 --Annexation cost
	AUTONOMY_LEVEL_CHANGE_PP_FREE = 1000, --was 300 --Break free cost
	MAX_SCORE_DIFF_TO_CHANGE_AUTONOMY = 10, --was 10 --The max diff between current freedom score and the cap for next or previous level allowed for changing
	MASTER_BUILD_AUTONOMY_FACTOR = -0.9, --was -0.7 --scales autonomy gain from construction by this
	VICTORY_POINT_WORTH_FACTOR = 25,--was 10				-- multiplier when calcualting proince worth (surrender)
	...
	IDEOLOGY_JOIN_FACTION_MIN_LEVEL = -0.01,--was 0.3		-- ideology limit required to join faction
...
NCountry = {
	EVENT_PROCESS_OFFSET = 25, --was 20 --Events are checked every X day per country or state (1 is ideal, but CPU heavy)
	...
	REINFORCEMENT_DELIVERY_SPEED_MIN = 0.35, --was 0.6 --The distance from the supply region to capital should affect the speed only a little bit. Main factor for penalty is overcrowded areas, and not the route length.
	REINFORCEMENT_EQUIPMENT_DELIVERY_SPEED = 0.15, --was 0.3 --Modifier for army equipment reinforcement speed
	REINFORCEMENT_MANPOWER_DELIVERY_SPEED = 20, --was 10.0 --Modifier for army manpower reinforcement delivery speed (travel time)
	REINFORCEMENT_MANPOWER_CHUNK = 0.025, --was 0.1 --Chunk size of manpower reinforcement delivery, in % of total manpower needed by the template.
	...
	SUPPLY_CONVOY_FACTOR = 0.01, --was 0.25 --How many convoys each supply needs
	...
	BASE_STABILITY_WAR_FACTOR = 0, --was -0.2 --Default stability war factor
	BASE_STABILITY_PARTY_POPULARITY_FACTOR = 0.2, --was 0.15 --Default stability rulling party popularity factor
	...
	WAR_SUPPORT_OFFNSIVE_WAR = -0.1, --was -0.2 --Impact of being in offensive war
	WAR_SUPPORT_DEFENSIVE_WAR = 0.2, --was 0.2 --Impact of being in defensive war
	...
	MAJOR_MIN_FACTORIES = 200, --was 35 --need at least these many factories to become a major
	...
	MIN_NAVAL_SUPPLY_EFFICIENCY = 0.01, --was 0.1 --Min ratio when supplies will be considered delivered from the capital by naval path
	...
	INVASION_REPORT_EXPERATION_DAYS = 10, --was 30 --Invasion experation days
	...
	BOMBING_WEEKLY_WAR_SUPPORT_PENALTY_DECAY = 0.01, --was 0.001 --Weekly decay of bomber damage war support penalty
	MAX_BOMBING_WAR_SUPPORT_IMPACT = -0.2, --was -0.3 --Max total penalty from bomber's damage
	...
	MAX_CONVOYS_BEING_RAIDED_WAR_SUPPORT_IMPACT = -0.25, --was -0.5 --Max total penalty from trade convoy raided
	...
	MAX_PROPAGANDA_STABILITY_IMPACT = -0.1, --was -0.2 --Max total penalty from operative performing the propaganda mission in a country
	MAX_PROPAGANDA_WAR_SUPPORT_IMPACT = -0.1, --was -0.2 --Max total penalty from operative performing the propaganda mission in a country
	...
	SPECIAL_FORCES_CAP_BASE = 0.08, --increased since Caps are different in Ultra --was 0.05 --Max ammount of special forces battalions is total number of non-special forces battalions multiplied by this and modified by a country modifier
	SPECIAL_FORCES_CAP_MIN = 36, --36 means all nations can have either: 2 divisions of Mountaineers/Marines or 1 Division of Paratroopers or 2 Commando Battalions --was 24 --You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
	...
	GIE_EXILE_TROOPS_DEPLOY_TRAINING_MAX_LEVEL = 6, --was 2 --Max XP exile troops can receive from training
	...
	GIE_CONVOY_ON_CREATION = 400, --was 10 -- Number of convoy a GiE will get on creation.


	SURRENDER_LIMIT_REDUCTION_PER_COLLABORATION = 0.0, --was 0.3 --each percent of collaboration will lower surrender limit by this percentage
...
NResistance = {
	...
	RESISTANCE_TARGET_BASE = 65, --was 35.0 --base resistance target percentage

	RESISTANCE_TARGET_MODIFIER_HAS_CLAIM = -10.0, --was -5.0 --resistance target modifier in % for states we have claim
	...
	RESISTANCE_TARGET_MODIFIER_OCCUPIED_CAPITULATED = -10.0, --was 10.0 --resistance target modifier when the enemy is capitulated
	...
	COMPLIANCE_GROWTH_BASE = 0.02, --was 0.075 --base compliance grow
	...
	SUPPRESSION_NEEDED_BY_RESISTANCE_POINT = 1.25, --was 0.75 --Number of suppression point we need for each 1% of resistance
	...
	MAX_GARRISON_RATIO_WE_AGREE_TO_SUPPORT = 0.3, --was 3.0 --The part of the manpower needed by the foreign garrison, that AI will agree to support with our manpower. If negative number, AI will not take into consideration the need, and just calculate how much they can give.
	...
	INITIAL_HISTORY_COMPLIANCE = 90.0, --was 70.0 --compliance value for initial colony states
...
NProduction = {
	MAX_EQUIPMENT_RESOURCES_NEED = 4, --was 3 --Max number of different strategic resources an equipment can be dependent on.
	MAX_CIV_FACTORIES_PER_LINE = 20, --was 15 --Max number of factories that can be assigned a single production line.
	DEFAULT_MAX_NAV_FACTORIES_PER_LINE = 10, --was 10
	FLOATING_HARBOR_MAX_NAV_FACTORIES_PER_LINE = 10, --was 5
	CONVOY_MAX_NAV_FACTORIES_PER_LINE = 250, --was 15
	CAPITAL_SHIP_MAX_NAV_FACTORIES_PER_LINE = 10, --was 5
	MAX_MIL_FACTORIES_PER_LINE = 500, --was 150
	RAILWAY_GUN_MAX_MIL_FACTORIES_PER_LINE = 500, --was 5
	...
	BASE_FACTORY_SPEED = 0.65, --was 5 --Base factory speed multiplier (how much hoi3 style IC each factory gives).
	BASE_FACTORY_SPEED_MIL = 1, --was 4.50 --Base factory speed multiplier (how much hoi3 style IC each factory gives).
	BASE_FACTORY_SPEED_NAV = 1.2, --was 2.5 --Base factory speed multiplier (how much hoi3 style IC each factory gives).
	BASE_FACTORY_START_EFFICIENCY_FACTOR = 1, --was 10 --Base start efficiency for factories expressed in %.
	BASE_FACTORY_MAX_EFFICIENCY_FACTOR = 65, --was 50 --Base max efficiency for factories expressed in %.
	BASE_FACTORY_EFFICIENCY_GAIN = 1.0, --was 1 --Base efficiency factor.
	BASE_FACTORY_EFFICIENCY_BALANCE_FACTOR = 0.1, --was 0.1 --Factory efficiency balancing factor
	BASE_FACTORY_EFFICIENCY_VARIANT_CHANGE_FACTOR = 95, --was 90 --Base factor for changing production variants in %.
	BASE_FACTORY_EFFICIENCY_PARENT_CHANGE_FACTOR = 90, --was 30 --Base factor for changing production parent<->children in %.
	BASE_FACTORY_EFFICIENCY_FAMILY_CHANGE_FACTOR = 50, --was 70 --Base factor for changing production with same family in %.
	...
	EQUIPMENT_LEND_LEASE_WEIGHT_FACTOR = 0.0005, --was 0.01 --Base equipment lend lease factor
	...
	ANNEX_FIELD_EQUIPMENT_RATIO = 0.9, --was 0.25 --How much equipment from deployed divisions will be transferred on annexation
	ANNEX_FUEL_RATIO = 0.8, --was 0.25 --How much fuel will be transferred on annexation
	ANNEX_CONVOYS_RATIO = 0.10,	--was 0.15	-- How many convoys will be transferred on annexation
	MIN_POSSIBLE_TRAINING_MANPOWER = 18000, --was 100000 --How many deployment lines minimum can be training
	MIN_FIELD_TO_TRAINING_MANPOWER_RATIO = 0.18, --was 0.75 --Ratio which % of army in field can be trained
	...
	CIC_BANK_SPEED_BOOST_FACTOR = 0.04,                 -- The CIC bank can boost production speed with this factor (0.5 means 50 %)
	MIN_LICENSE_ACTIVE_DAYS = 30,						-- Min days for license to be active
	BASE_LICENSE_IC_COST = 0, --was 1 --Base IC cost for lended license
	LICENSE_IC_COST_YEAR_INCREASE = 0.25, --was 1 --IC cost equipment for every year of equipment after 1936
	LICENSE_EQUIPMENT_BASE_SPEED = -0.35, --was -0.25 --base MIC speed modifier for licensed equipment
	LICENSE_EQUIPMENT_TECH_SPEED_PER_YEAR = 0, --was -0.05 --MIC speed modifier for licensed equipment for each year of difference between actual and latest equipment
	LICENSE_EQUIPMENT_TECH_SPEED_MAX_YEARS = 0, --was 4 --Maximum years for MIC speed modifier
	LICENSE_EQUIPMENT_SPEED_NOT_FACTION = -0.40, --was -0.10 --MIC speed modifier for licensed equipment for not being in faction
	LICENSE_EQUIPMENT_UPGRADE_XP_FACTOR = 2.0, --was 2.0 --XP cost for upgrading licensed equipment
	LICENSE_EQUIPMENT_SPEED_NO_LICENSE = -0.80, --was -0.50 --Penalty for producing non licensed equipment
	CONVERSION_SPEED_BONUS = 4, --was 0 --Modifier to the production speed when converting equipment
	EQUIPMENT_MODULE_ADD_XP_COST = 1.0, --was 5.0 --XP cost for adding a new equipment module in an empty slot when creating an equipment variant.
	EQUIPMENT_MODULE_REPLACE_XP_COST = 1.0, --was 6.0 --XP cost for replacing one equipment module with an unrelated module when creating an equipment variant.
	EQUIPMENT_MODULE_CONVERT_XP_COST = 1.0, --was 3.0 --XP cost for converting one equipment module to a related module when creating an equipment variant.
	EQUIPMENT_MODULE_REMOVE_XP_COST = 1.0, --was 1.0 --XP cost for removing an equipment module and leaving the slot empty when creating an equipment variant.
	BASE_NAVAL_EQUIPMENT_CONVERSION_IC_COST_FACTOR = 0.02, --was 0.2 --Fraction of the hull industry cost which is always included in the refitting cost.
	...
	MIN_NAVAL_EQUIPMENT_CONVERSION_RESOURCE_COST_FACTOR = 0.2, --was 0.2 --Minimum fraction of a naval equipment's strategic resource cost that any conversion will cost.
...
NMarket = {
	...
	MIN_DELIVERY_LIMIT_WARNING_UI = 0.9,							-- The delivery percentage under we want to let player know the contract is inefficient. [0,1]
	PURCHASE_CONTRACT_SUBSIDY_BONUS_SPEED_FACTOR = 1.0,				-- The factor of speed bonus from subsidies
	CONVOY_WEIGHT_OVERRIDE = 0.0,									-- Overrides the default lend lease weight of convoys for international market
...
NTechnology = {
	MAX_SUBTECHS = 13, --was 3 --Max number of sub technologies a technology can have.
	BASE_RESEARCH_POINTS_SAVED = 30.0, --was 30.0 --Base amount of research points a country can save per slot.
	BASE_YEAR_AHEAD_PENALTY_FACTOR = 25, --was 2 --Base year ahead penalty
	BASE_TECH_COST = 110, --was 100 --Base cost for a tech. multiplied with tech cost and ahead of time penalties
	MAX_TECH_SHARING_BONUS = 10, --was 0.5 --Max technology sharing bonus that can be applied instantly
	LICENSE_PRODUCTION_TECH_BONUS = 0.15, --was 0.2 --License production tech bonus
	...
	MIN_RESEARCH_SPEED = 0.1, --was 0.1 --research speed can't go below this value
...
NPolitics = {
	...
	ARMY_LEADER_COST = 2, --was 5 --command power cost for recruiting new leaders, 'this value' * number_of_existing_leaders_of_type
	NAVY_LEADER_COST = 1, --was 5 --command power cost for recruiting new leaders, 'this value' * number_of_existing_leaders_of_type
	...
	DEFAULT_OCCUPATION_POLICY = 3, --was 1 --Defaullt value for occupation policy
	INSTANT_WIN_REVOLTER_POPULARITY_RATIO = 0.4, -- Min party popularity for instant win in one province state
	INSTANT_WIN_POPULARITY_WIN = 55, --was 50 --New party popularity
},
...
NBuildings = {
	...
	MAX_BUILDING_LEVELS = 200, --was 15 --Max levels a building can have.
	AIRBASE_CAPACITY_MULT = 72, --was 200 --Each level of airbase building multiplied by this, gives capacity (max operational value). Value is int. 1 for each airplane.
	...
	NAVALBASE_REPAIR_MULT = -0.015, --has to be negative as it scales with dockyard output. As long as dockyard output is set to -400% base for MIOs this has to stay negative to enable ship repair --was 0.05 --Each level of navalbase building repairs X strength and can repair as many ships as its level
	RADAR_RANGE_BASE = 15, --was 20 --Radar range base, first level radar will be this + min, best radar will be this + max
	RADAR_RANGE_MIN = 15, --was 20 --Radar range (from state center to province center) in measure of map pixels. Exluding techs.
	RADAR_RANGE_MAX = 120, --was 200 --Range is interpolated between building levels 1-15.
	RADAR_INTEL_EFFECT = 30, --was 40 --Province covered by radar increases intel by 10 (where 255 is max). Province may be covered by multiple radars, then the value sums up.
	SABOTAGE_FACTORY_DAMAGE = 75.0, --was 100.0 --How much damage takes a factory building in sabotage when state is occupied. Damage is mult by (1 + resistance strength), i.e. up to 2 x base value.
	...
	SUPPLY_ROUTE_RESOURCE_BONUS = 0.0, --was 0.2 --multiplicative resource bonus for having a railway/naval connection to the capital
	INFRASTRUCTURE_MUD_EFFECT = -0.65, --was -0.8 --multiplicative effect on mud growth for max infra
},
...
NMilitary = {
	COMBAT_VALUE_ORG_IMPORTANCE = 1.3, --was 1 --Multiplier on TotalOrganisation when determining the combat value of a division
	...
	HOURLY_ORG_MOVEMENT_IMPACT = -0.2, --was -0.2 --how much org is lost every hour while moving an army.
	ZERO_ORG_MOVEMENT_MODIFIER = -0.2, --was -0.8 --speed impact at 0 org.
	INFRA_ORG_IMPACT = 0.4, --was 0.5 --scale factor of infra on org regain.
	ENGAGEMENT_WIDTH_PER_WIDTH = 2.0,	-- how much enemy combat width we are allowed to engage per width of our own

	INFRASTRUCTURE_MOVEMENT_SPEED_IMPACT = -0.02, --was -0.05 --speed penalty per infrastucture below maximum.
	...
	WAR_SCORE_LOSSES_RATIO = 0, --was 0.5 --war score gained for every 1000 casualties
	...
	CORPS_COMMANDER_DIVISIONS_CAP = 10, --was 24 --how many divisions a corps commander is limited to. 0 = inf, < 0 = blocked
	...
	FIELD_MARSHAL_DIVISIONS_CAP = 12, --was 24 --how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
	FIELD_MARSHAL_ARMIES_CAP = 8, --was 5 --how many armies a field marshall is limited to. 0 = inf, < 0 = blocked

	UNIT_LEADER_GENERATION_CAPITAL_CONTINENT_FACTOR = 100, --Integer factor to multiply manpower.

	RECON_SKILL_IMPACT = 10, --was 5 --how many skillpoints is a recon advantage worth when picking a tactic.
	...
	BASE_DIVISION_SUPPORT_SLOT_COST = 0, --was 10 --Base cost to unlock a support slot

	MAX_ARMY_EXPERIENCE = 900, --was 500 --Max army experience a country can store
	MAX_NAVY_EXPERIENCE = 900, --was 500 --Max navy experience a country can store
	MAX_AIR_EXPERIENCE = 900, --was 500 --Max air experience a country can store

	COMBAT_MINIMUM_TIME = 2, --was 4 --Shortest time possible for a combat in hours
	SPOTTING_QUALITY_DROP_HOURS = 5, --was 4 --Each X hours the intel quality drops after unit was spotted.
	...
	RELIABILTY_RECOVERY = 0.06,                     -- factor affecting how much equipment is returned "from the dead"
	BASE_CHANCE_TO_AVOID_HIT = 80, --was 90 --Base chance to avoid hit if defences left.
	CHANCE_TO_AVOID_HIT_AT_NO_DEF = 60, --was 60 --chance to avoid hit if no defences left.
	COMBAT_MOVEMENT_SPEED = 0.33, --was 0.33 --speed reduction base modifier in combat
	TACTIC_SWAP_FREQUENCEY = 12, --was 12 --hours between tactic swaps
	...
	INITIATIVE_PICK_COUNTER_ADVANTAGE_FACTOR  = 0.45, --was 0.35 --advantage per leader level for picking a counter
	...
	RIVER_CROSSING_PENALTY = -0.2, --was -0.3 --small river crossing
	RIVER_CROSSING_PENALTY_LARGE = -0.4, --was -0.6 --large river crossing
	RIVER_CROSSING_SPEED_PENALTY = 0, --was -0.25 --small river crossing
	RIVER_CROSSING_SPEED_PENALTY_LARGE = 0, --was -0.5 --large river crossing
	RIVER_SMALL_START_INDEX = 0,                   -- color indices for rivers
	RIVER_SMALL_STOP_INDEX = 6,
	RIVER_LARGE_STOP_INDEX = 11,
	BASE_FORT_PENALTY = -0.1, --was -0.15 --fort penalty
	MULTIPLE_COMBATS_PENALTY = -0.5, --was -0.5 --defender penalty if attacked from multiple directions
	DIG_IN_FACTOR = 0.02, --was 0.02 --bonus factor for each dug-in level
	ARMY_LEADER_XP_GAIN_PER_UNIT_IN_COMBAT = 0.11, --was 0.1 --XP gain per unit in combat
	...
	BASE_LEADER_TRAIT_GAIN_XP = 0.45, --was 0.45 --Base xp gain for traits per hour for armies
	MAX_NUM_TRAITS = -1,						   -- cant have more, -1 to disable
	ENEMY_AIR_SUPERIORITY_IMPACT = -0.1, --was -0.35 --effect on defense due to enemy air superiorty
	...
	TRAINING_ORG = 0.2,
	ARMY_EXP_BASE_LEVEL = 6, --was 1
	UNIT_EXP_LEVELS = {
	0.040, -- 1 Green			-- green clover
	0.060, -- 2 Fresh			-- bronze clover
	0.090, -- 3 Rookie			-- frame
	0.120, -- 4 Amateur			-- chevron, max deploy level
	0.180, -- 5 Trained			-- double chevron
	0.240, -- 6 Regular			-- bronze star, max training level
	0.320, -- 7 Seasoned		-- silver star
	0.420, -- 8 Battlehardened	-- gold star
	0.530, -- 9 Veteran			-- bronze star with leaves
	0.660, -- 10 Legendary		-- silver star with leaves
	...
	PARACHUTE_COMPLETE_ORG = 0.3, --was 0.4 --Organisation value (in %) after unit being dropped, regardless if failed, disrupted, or successful.
	PARACHUTE_ORG_REGAIN_PENALTY_DURATION = 12, --was 120 --penalty in org regain after being parachuted. Value is in hours.
	PARACHUTE_ORG_REGAIN_PENALTY_MULT = -0.5, --was -0.8 --penalty to org regain after being parachuted.
	...
	SUPPLY_ORG_MAX_CAP = 0.1, --was 0.35 --Max organization is factored by this if completely out of supply
	MAX_OUT_OF_SUPPLY_DAYS = 14, --was 30 --how many days of shitty supply until max penalty achieved
	OUT_OF_SUPPLY_ATTRITION = 0.025, --was 0.20 --max attrition when out of supply
	OUT_OF_SUPPLY_SPEED = -0.1, --was -0.8 --max speed reduction from supply
	NON_CORE_SUPPLY_SPEED = -0.1, --was -0.5 --we are not running on our own VP supply so need to steal stuff along the way
	...
	OUT_OF_SUPPLY_MORALE = -0.25, --was -0.2 --max org regain reduction from supply
	TRAINING_ATTRITION = 0.01, --was 0.05 --amount of extra attrition from being in training
	...
	AIR_SUPPORT_BASE = 0.2, --was 0.25 --CAS bonus factor for air support moddifier for land unit in combat
	LOW_SUPPLY = 0.99, --was 0.99 --When the supply status of an unit becomes low.
	...
	OVERSEAS_LOSE_EQUIPMENT_FACTOR = 1.0, --was 0.75 --percentage of equipment lost disbanded overseas
	NAVAL_TRANSFER_DISBAND_MANPOWER_FACTOR = 0.5,  -- percentage of manpower returned when a naval transfering unit is disbanded
	ENCIRCLED_DISBAND_MANPOWER_FACTOR = 0.0, --was 0.2 --percentage of manpower returned when an encircled unit is disbanded
	...
	PLANNING_DECAY = 0.01, --was 0.01
	PLAYER_ORDER_PLANNING_DECAY = 0.03, --was 0.03 --Amount of planning lost due to player manual order
	PLANNING_GAIN = 0.005,
	...
	PLANNING_MAX = 0.2, --was 0.3 --can get more from techs
	CIVILWAR_ORGANIZATION_FACTOR = 0.3,			  	-- Multiplier of org for both sides when civilwar.
	PLAN_CONSIDERED_GOOD = 0.5, --was 0.25 --Plan evaluations above this value are considered more or less safe
	PLAN_CONSIDERED_BAD = 0.05, --was -0.25 --Plan evaluations below this value are considered unsafe
	PLAN_MIN_AUTOMATED_EMPTY_POCKET_SIZE = 5, --was 2 --The battle plan system will only automatically attack provinces in pockets that has no resistance and are no bigger than these many provinces
	PLAN_SPREAD_ATTACK_WEIGHT = 3, --was 12.0 --The higher the value, the less it should crowd provinces with multiple attacks.
	...
	PLAN_AREA_DEFENSE_FORT_IMPORTANCE = 1.0, --was 0.25 --Used when calculating the value of defense area provinces for the battle plan system, works as multipliers on the rest
	...
	PLAN_EXECUTE_RUSH = -10, --was -200 --When looking for an attach target, this score limit is required in the battle plan to consider province for attack
	...
	NUKE_MIN_DAMAGE_PERCENT = 0.01, --was 0.1 --Minimum damage from nukes as a percentage of current strength/organisation
	NUKE_MAX_DAMAGE_PERCENT = 0.09, --was 0.9 --Minimum damage from nukes as a percentage of current strength/organisation
	...
	COMBAT_OVER_WIDTH_PENALTY = -1.5, --was -1.5 --over combat width penalty per %.
	COMBAT_OVER_WIDTH_PENALTY_MAX = -0.33, --over combat width max (when you cant join no more).
	RETREAT_SPEED_FACTOR = 0.4, --was 0.25 --speed bonus when retreating
	WITHDRAWING_SPEED_FACTOR = 0, --was 0.15 --speed bonus when withdrawing
	STRATEGIC_SPEED_INFRA_BASE = 2.5, --was 5.0 --Base speed of strategic redeployment when not on railways
	STRATEGIC_SPEED_INFRA_MAX = 1.0, --was 10.0 --Additional speed of strategic redeployment on max-level infrastructure
	STRATEGIC_SPEED_RAIL_BASE = 8.0, --was 15.0 --Base speed of strategic redeployment when on railways
	STRATEGIC_SPEED_RAIL_MAX = 4.0, --was 25.0 --Additional speed of strategic redeployment on max-level railways
	...
	FASTER_ORG_REGAIN_LEVEL = 0.2, --was 0.25
	FASTER_ORG_REGAIN_MULT = 0.2, --was 1.0
	SLOWER_ORG_REGAIN_LEVEL = 0.8, --was 0.80
	SLOWER_ORG_REGAIN_MULT = -0.2, --was -0.5

	DISBAND_MANPOWER_LOSS = 0.0, --was 0.0
	MIN_DIVISION_DEPLOYMENT_TRAINING = 0.4, --was 0.2 --Min level of division training
	...
	FRONT_MIN_PATH_TO_REDEPLOY = 4, --was 8 --If a units path is at least this long to reach its front location, it will strategically redeploy.
	ARMY_INITIATIVE_REINFORCE_FACTOR = 0.25,		-- scales initiative for reinforce chance

	BASE_CAPTURE_EQUIPMENT_RATIO = 0.00, --was 0.0 --after a successful land combat, ratio of the equipments that are being captured/salvaged from enemy's lost equipment

	ACCLIMATIZATION_IN_COMBAT_SPEED_FACTOR = 3,		-- Acclimatization speed multiplier while being in combat.
	ACCLIMATIZATION_SPEED_GAIN = 0.08, --was 0.15 --A variable used to balance the overall speed of gaining the acclimatization
	...
	UNIT_LEADER_USE_NONLINEAR_XP_GAIN = false, --was true --Whether unit leader XP gain is scaled by 1/<nr_of_traits>
	...
	UNIT_LEADER_MODIFIER_COOLDOWN_ON_GROUP_CHANGE = 3, --was 15 --time in days for a unit leader to regain its modifiers
	...
	MAX_RELATIVE_COMBAT_DAMAGE_TO_MODIFY_XP = 10, --was 4.0 --you gain more XP if you are doing more damage relative to enemy, this is the max relative amount to gain following RATe
	XP_GAIN_FACTOR_FOR_MAX_RELATIVE_COMBAT_DAMAGE = 5, --was 4.0 --XP factor scaling for max relative combat damage

	XP_DECAY_RATE_PER_HOUR_IN_COMBAT = 0.03, --was 0.03 --you get reduced XP as combat drags
	MIN_XP_RATE_TO_DECAY = 0.1, --was 0.1 --minimum XP factor for dragged combats

	XP_GAIN_PER_OVERRUN_UNIT = 50, --was 35.0 --fixed XP gain per overrun unit
	XP_GAIN_FOR_SHATTERING = 50, --was 35.0 --fixed XP gain per shattered unit

	UNIT_UPKEEP_ATTRITION = 0.000, --was 0.00 --Constant attrition value applied to armies.
	...
	ARMY_MAX_FUEL_FLOW_MULT = 11.0, --was 2.0 --max fuel ratio that an army can get per hour, multiplied by supply situation
	...
	OUT_OF_FUEL_EQUIPMENT_MULT = 0.15, --was 0.1 --ratio of the stats that you get from equipments that uses fuel and you lack it
	OUT_OF_FUEL_SPEED_MULT = 1, --was 0.4 --speed mult that armies get when out of fuel
	OUT_OF_FUEL_TRAINING_XP_GAIN_MULT = 0.0,		-- xp gain mult from training when a unit is out of fuel
	FUEL_CAPACITY_DEFAULT_HOURS = 240, --was 96 --default capacity if not specified
...
NAir = {
	...
	AIR_WING_MAX_STATS_DEFENCE = 400, --was 100
	AIR_WING_MAX_STATS_AGILITY = 1500, --was 100
	AIR_WING_MAX_STATS_SPEED = 200, --was 800
	AIR_WING_MAX_STATS_BOMBING = 150, --was 100
	...
	DETECT_CHANCE_FROM_NIGHT = -0.4, --was -0.2 --How much the night can reduce the air detection. (see static modifiers to check how weather affects it too.)
	...
	DETECT_EFFICIENCY_FROM_RADAR = 0.5, --was 0.7 --How much radars affect the efficiency.
	DETECT_EFFICIENCY_RANDOM_FACTOR = 0.8,				-- How much randomness is in amount of detected aircrafts.
	...
	AIR_AGILITY_TO_NAVAL_STRIKE_AGILITY = 0.001,         		-- conversion factor to bring agility in line with ship AA
	...
	AIR_NAVAL_KAMIKAZE_DAMAGE_MULT = 40.0, --was 20.0 --Balancing value to increase usual damage to Strength for Kamikaze
	...
	BASE_STRATEGIC_BOMBING_HIT_PLANE_CHANCE = 0.08,		-- Chance to hit a plane in airbase when it is bombed.
	BASE_STRATEGIC_BOMBING_HIT_PLANE_DAMAGE_FACTOR = 150.0,
	...
	EFFICIENCY_REGION_CHANGE_PENALTY_FACTOR = 0.99, --was 0.9 --Penalty applied for changing region
	-- Gain should be changed in increments of 0.024 due to precision.
	EFFICIENCY_REGION_CHANGE_DAILY_GAIN_DEFAULT = 0.5, --was 1 --Default how much efficiency to regain per day. Gain applied hourly.
	EFFICIENCY_REGION_CHANGE_DAILY_GAIN_CAS = 0.72, --was 0.888 --How much efficiency to regain per day. Gain applied hourly.
	EFFICIENCY_REGION_CHANGE_DAILY_GAIN_NAVAL_BOMBER = 0.192, --was 0.192 --How much efficiency to regain per day. Gain applied hourly.
	EFFICIENCY_REGION_CHANGE_DAILY_GAIN_TACTICAL_BOMBER = 0.12, --was 0.192 --How much efficiency to regain per day. Gain applied hourly.
	EFFICIENCY_REGION_CHANGE_DAILY_GAIN_FIGHTER = 0.72, --was 0.888 --How much efficiency to regain per day. Gain applied hourly.
	EFFICIENCY_REGION_CHANGE_DAILY_GAIN_STRATEGIC_BOMBER = 0.096, --was 0.072 --How much efficiency to regain per day. Gain applied hourly.
	EFFICIENCY_REGION_CHANGE_DAILY_GAIN_MARITIME_PATROL_PLANE = 0.192, --was 1

	AIR_WING_XP_MAX = 1200.0, 											--Per plane XP.
	AIR_WING_XP_LEVELS = { 100, 400, 600, 1100 }, 						--Experience needed to progress to the next level
	AIR_WING_XP_LOSS_WHEN_KILLED = 400,									--if a plane dies, the game assumes that a pilot with this amount of xp died and recalcs average.
	AIR_WING_XP_TRAINING_MAX = 400.0, 									--Max average XP achieved with training.

	AIR_WING_XP_TRAINING_MISSION_GAIN_DAILY = 3.0, --was 7.0 --Daily gain when running training exercise mission
	AIR_WING_XP_AIR_VS_AIR_COMBAT_GAIN = 2.0, --was 0.8 --Wings in combat gain extra XP
	AIR_WING_XP_GROUND_MISSION_COMPLETED_GAIN = 0.50, --was 0.28 --Bombers bombing, CAS cassing, NBs nbing, kamikazees kamikazeeing, etc.
	AIR_WING_XP_RECON_MISSION_COMPLETED_GAIN = 0.6, --was 0.05 --recon mission

	AIR_WING_COUNTRY_XP_FROM_TRAINING_FACTOR = 0.005, --was 0.003 --Factor on country Air XP gained from wing training
	...
	DISRUPTION_FACTOR_CARRIER = 6.00, --was 6.0 --multiplier on disruption damage to scale its effects on carrier vs carrier planes
	...
	DISRUPTION_DETECTION_FACTOR = 1.0, --was 1.0
	ESCORT_FACTOR = 1.0, --was 2.0
	ESCORT_SPEED_FACTOR = 0.0, --was 1.0
	ESCORT_AGILITY_FACTOR = 0.0, --was 1.0
	ESCORT_ATTACK_FACTOR = 0.25, --was 1.0
	DISRUPTION_DEFENCE_DEFENCE_FACTOR = 0.0, --was 0.5
	...
	AIR_WING_ATTACK_LOGISTICS_NO_TRUCK_DISRUPTION_FACTOR = 0.05, --was 0.02 --If a unit isn't motorized, still disrupt its supply by damage * this
	AIR_WING_ATTACK_LOGISTICS_TRUCK_DAMAGE_FACTOR = 0.125, --was 0.27
	AIR_WING_ATTACK_LOGISTICS_INFRA_DAMAGE_SPILL_FACTOR = 0.001, --was 0.0016 --Portion of truck damage to additionally deal to infrastructure
	AIR_WING_ATTACK_LOGISTICS_TRAIN_DAMAGE_FACTOR = 0.003, --was 0.040
	...
	MIN_PLANE_COUNT_PARADROP = 72, --was 50
	MIN_PLANE_COUNT_AIR_SUPPLY = 1,
	BASE_UNIT_WEIGHT_IN_TRANSPORT_PLANES = 64, --was 45.0
	...
	BOMBING_TARGETING_RANDOM_FACTOR = 0.25, --was 0.25 --% of picking the wrong target
	...
	BOMBING_INFRA_PRIO_SCALE = 1.5,									-- Scale of the selected priority for infastryctyre
	NAVAL_MINES_PLANTING_SPEED_MULT = 0.01, --was 0.025 --Value used to overall balance of the speed of planting naval mines
	NAVAL_MINES_SWEEPING_SPEED_MULT = 0.009, --was 0.025 --Value used to overall balance of the speed of sweeping naval mines
	...
	THRUST_WEIGHT_AGILITY_FACTOR = 0.5,								-- For plane designs, additive Km/h max speed bonus per point of thrust exceeding weight
	MAX_QUICK_WING_SELECTION = 6, --was 3 --Max possible selection for airwing quick deploy
...
NNavy = {
	...
	RESOURCE_LENDLEASE_PRIORITY = 0.2, --was 3 --Default convoy priority for export lend lease
	...
	DETECTION_CHANCE_MULT_RADAR_BONUS = 0.05, --was 0.1 --detection chance bonus from radars.
	DETECTION_CHANCE_MULT_AIR_SUPERIORITY_BONUS = 0.25, --was 0.25 --bonus from air superiority.
	...
	MAX_SUBMARINES_PER_AUTO_TASK_FORCE = 10, --was 30 --maximum number of submarines the auto-task force creation will put together when designing wolfpack
	BEST_CAPITALS_TO_CARRIER_RATIO = 1.5, --was 1 --capitals / carriers ratio used when auto-task force creation designs CarrierTaskForce
	...
	REPAIR_AND_RETURN_PRIO_LOW_COMBAT = 0.5, --was 0.6 --% of total Strength. When below, navy will go to home base to repair (in combat).
	REPAIR_AND_RETURN_PRIO_MEDIUM_COMBAT = 0.7, --was 0.3 --% of total Strength. When below, navy will go to home base to repair (in combat).
	REPAIR_AND_RETURN_PRIO_HIGH_COMBAT = 0.9, --was 0.1 --% of total Strength. When below, navy will go to home base to repair (in combat).
	REPAIR_AND_RETURN_AMOUNT_SHIPS_LOW = 0.4, --was 0.2 --% of total damaged ships, that will be sent for repair-and-return in one call.
	...
	CONVOY_EFFICIENCY_REGAIN_AFTER_DAYS = 5, --was 7 --Convoy starts regaining it's efficiency after X days without any convoys being sink.
	...
	ANTI_AIR_TARGETTING_TO_CHANCE = 0.18, --was 0.2 --Balancing value to convert averaged equipment stats (anti_air_targetting and naval_strike_agility) to probability chances of airplane being hit by navies AA.
	ANTI_AIR_ATTACK_TO_AMOUNT = 0.004, --was 0.01 --Balancing value to convert equipment stat anti_air_attack to the random % value of airplanes being hit.
	...
	AMPHIBIOUS_LANDING_PENALTY = 0, --was -0.7 --amphibious landing penalty
	...
	BASE_CARRIER_SORTIE_EFFICIENCY = 0.50, --was 0.5 --factor of planes that can sortie by default from a carrier
	...
	NAVAL_TRANSFER_BASE_SPEED = 6, --was 6 --base speed of units on water being transported
	...
	CARRIER_STACK_PENALTY_EFFECT = 0.075, --was 0.2 --Each carrier above the optimal amount decreases the amount of airplanes being able to takeoff by such %. This is also the minimum value for carrier efficiency - no matter how many carriers are brought, efficiency will not go below this number.
	...
	MANPOWER_LOSS_RATIO_ON_STR_LOSS = 0.4, --was 0.5 --losing strength will make you also lose manpower at this ratio of total manpower
	...
	PRIDE_OF_THE_FLEET_UNASSIGN_COST = 50, --was 100 --cost to unassign/replace pride of the fleet
	...
	ON_BASE_FUEL_COST = 0.01, --was 0.0 --ships that waits at naval bases cost this ratio
	...
	AGGRESSION_MAX_ARMOR_EFFICIENCY = 1.25, --was 1.5 --armor multiplier has a min and max caps while being factored in aggression

	AGGRESSION_LIGHT_GUN_EFFICIENCY_ON_LIGHT_SHIPS = 0.5, --was 1.0 --ratio for scoring for different gun types against light ships
	AGGRESSION_HEAVY_GUN_EFFICIENCY_ON_LIGHT_SHIPS = 0.25, --was 0.25 --ratio for scoring for different gun types against light ships
	AGGRESSION_TORPEDO_EFFICIENCY_ON_LIGHT_SHIPS = 0.8, --was 0.1 --ratio for scoring for different gun types against light ships

	AGGRESSION_LIGHT_GUN_EFFICIENCY_ON_HEAVY_SHIPS = 0.1, --was 0.1 --ratio for scoring for different gun types against heavy ships
	AGGRESSION_HEAVY_GUN_EFFICIENCY_ON_HEAVY_SHIPS = 0.5, --was 1.0 --ratio for scoring for different gun types against heavy ships
	AGGRESSION_TORPEDO_EFFICIENCY_ON_HEAVY_SHIPS = 1.0, --was 1.1 --ratio for scoring for different gun types against heavy ships
	...
	MAX_ORG_ON_MANUAL_MOVE = 1.0, --was 0.66 --org will clamped to this ratio on manual move
	...
	SUPREMACY_PER_SHIP_BASE = 10.0, --was 0
	...
	NAVAL_MINES_SWEEPING_SPEED_MULT = 0.009, --was 0.009 --Value used to overall balance of the speed of sweeping naval mines
	NAVAL_MINES_DECAY_AT_PEACE_TIME = 0.25, --was 0.25 --How fast mines are decaying in peace time. Planting mines in peace time may be exploitable, so it's blocked atm. That's why after war we should decay them too.
	NAVAL_MINES_SWEEPERS_REDUCTION_ON_PENALTY_EFFECT = 3.3, --was 3.3 --How much is the task force's sweeping attribute reducing the penalty effect.
	NAVAL_MINES_INTEL_DIFF_FACTOR = 0.2, --was 0.1 --Better our decryption over enemy encryption will reduce the penalties from the enemy mines in the region. This value is a factor to be used for balancing.
	...
	NAVAL_MINES_ACCIDENT_CRITICAL_HIT_CHANCES = 0.1, --was 0.14 --If an accident happens, how likely it is to be a critical hit (caused by naval mines)
	NAVAL_MINES_ACCIDENT_CRITICAL_HIT_DAMAGE_SCALE = 5.0,			-- Scale the value below in case of critical hit (caused by naval mines)
	NAVAL_MINES_ACCIDENT_STRENGTH_LOSS = 20.0, --was 75.0 --Amount of strength loss when hit by naval mine
	NAVAL_MINES_ACCIDENT_ORG_LOSS_FACTOR = 0.8, --was 0.6 --Amount of strength loss when hit by naval mine

	TRAINING_ACCIDENT_CHANCES = 0.000, --was 0.02 --Chances one ship get damage each hour while on training
	...
	TRAINING_ACCIDENT_STRENGTH_LOSS_FACTOR = 0.005, --was 0.05 --Amount of strength loss in a training accident, propotional to the maximum strength of the ship
	...
	TRAINING_DAILY_COUNTRY_EXP_FACTOR = 0.00025, --was 0.001 --Factor used to scale the Daily Country Navy XP gain
	...
	SPOTTING_ENEMY_SPOTTING_MULTIPLIER_FOR_RUNNING_AWAY = 0.8, --was 0.80 --enemy spotting is multiplied by this value to simulate running away
	...
	SPOTTING_SPEED_MULT_FOR_CATCHING_UP = 0.25, --was 0.2 --speed diff bonus rate that is added to spotting every hour
	...
	NAVY_VISIBILITY_BONUS_ON_RETURN_FOR_REPAIR = 0.6, --was 0.9 --Multiplier for the surface/sub visiblity when the heavily damaged fleet is returning to the home base for reparation. 1.0 = no bonus. 0.0 = invisible.
	...
	BASE_ESCAPE_SPEED = 0.045, --was 0.045 --daily base escape speed (gained as percentagE)
	SPEED_TO_ESCAPE_SPEED = 1.0, --was 0.95 --ratio to converstion from ship speed to escape speed (divided by hundred)
	ESCAPE_SPEED_PER_COMBAT_DAY = 0.1, --was 0.01 --daily increase in escape speed during combat duration
	MAX_ESCAPE_SPEED_FROM_COMBAT_DURATION = 0.2, --was 0.15 --max escape speed that will be gained from combat duration
	ESCAPE_SPEED_SUB_BASE = 0.12, --was 0.08 --subs get faster escape speed. gets replaced by hidden version below if hidden
	ESCAPE_SPEED_HIDDEN_SUB = 0.5, --was 0.18 --hidden subs get faster escape speed

	SUB_DETECTION_CHANCE_BASE = 7.5, --was 5 --to start spotting a submarine, a dice is rolled and checked if it succeeds this percentage. if not, that enemy sub force won't be spotted on this tick
	SUB_DETECTION_CHANCE_BASE_SPOTTING_EFFECT = 0.5, --was 0.5 --effect of base spotting for initial spotting of pure submarine forces. this along with next value is added together and rolled against a random to start spotting
	SUB_DETECTION_CHANCE_SPOTTING_SPEED_EFFECT = 2.0, --was 2.0 --effect of spotting speed for initial spotting of pure submarine forces. this along with prev value is added together and rolled against a random to start spotting
	SUB_DETECTION_CHANCE_BASE_SPOTTING_POW_EFFECT = 1.5, --was 1.5 --effect of spotting speed will be powered by this for initial spotting of pure submarine forces. this along with prev value is added together and rolled against a random to start spotting
	...
	UNIT_TRANSFER_SPOTTING_SPEED_MULT = 1.0, --was 5.0 --spotting speed mult against unit transfers
	NAVAL_INVASION_SPOTTING_SPEED_MULT = 3.0, --was 10.0 --spotting speed mult against naval invasion armies


	CONVOY_DETECTION_CHANCE_BASE = 2.06, --was 4.12 --regular convoy base chance detection percentage (if this fails, no detection is done on that tick)
	BASE_SPOTTING_EFFECT_FOR_INITIAL_CONVOY_SPOTTING = 0.35, --was 0.05 --effect of base convoy spotting for initial spotting of regular convoys. this along with next value is added together and rolled a random  once for every convoy to check for spotting
	SPOTTING_SPEED_EFFECT_FOR_INITIAL_CONVOY_SPOTTING = 0.70, --was 0.50 --effect of convoy spotting speed for initial spotting of regular convoys. this along with prev value is added together and rolled a random once for every convoy to check for spotting
	...
	UNIT_TRANSFER_DETECTION_CHANCE_BASE = 4.0, --was 8.0 --unit transfer and naval invasion base chance detection percentage (if this fails, no detection is done on that tick)
	BASE_SPOTTING_EFFECT_FOR_INITIAL_UNIT_TRANSFER_SPOTTING = 0.35, --was 2.4 --same as BASE_SPOTTING_EFFECT_FOR_INITIAL_CONVOY_SPOTTING, but for naval transfer convoys
	SPOTTING_SPEED_EFFECT_FOR_INITIAL_UNIT_TRANSFER_SPOTTING = 0.70, --was 0.12 --same as SPOTTING_SPEED_EFFECT_FOR_INITIAL_CONVOY_SPOTTING, but for naval transfer convoys
	BASE_SPOTTING_EFFECT_FOR_INITIAL_NAVAL_INVASION_SPOTTING = 0.35, --was 2.4 --same as BASE_SPOTTING_EFFECT_FOR_INITIAL_CONVOY_SPOTTING, but for naval invasion convoys
	SPOTTING_SPEED_EFFECT_FOR_INITIAL_NAVAL_INVASION_SPOTTING = 0.70, --was 0.12 --same as SPOTTING_SPEED_EFFECT_FOR_INITIAL_CONVOY_SPOTTING, but for naval invasion convoys
	...
	RELATIVE_SURFACE_DETECTION_TO_POSITIONING_FACTOR				= 0.1, --was 0.01 --multiples the surface detection difference between two sides. the side with higher detection will get a bonus of this value
	MAX_POSITIONING_BONUS_FROM_SURFACE_DETECTION					= 0.0, --was 0.0 --will clamp the bonus that you get from detection

	HIGHER_SHIP_RATIO_POSITIONING_PENALTY_FACTOR					= 0.5, --was 0.25 --if one side has more ships than the other, that side will get this penalty for each +100% ship ratio it has
	MAX_POSITIONING_PENALTY_FROM_HIGHER_SHIP_RATIO					= 1.0, --was 0.75 --maximum penalty to get from larger fleets

	HIGHER_CARRIER_RATIO_POSITIONING_PENALTY_FACTOR					= 0.1, --was 0.2; --penalty if other side has stronger carrier air force
	MAX_CARRIER_RATIO_POSITIONING_PENALTY_FACTOR 					= 0.1, --was 0.2; --max penalty from stronger carrier air force
	...
	MAX_POSITIONING_PENALTY_FOR_NEWLY_JOINED_SHIPS 					= 0.25, --was 0.25 --the accumulated penalty from new ships will be clamped to this value
	POSITIONING_PENALTY_HOURLY_DECAY_FOR_NEWLY_JOINED_SHIPS			= 0.05, --was 0.05 --the accumulated penalty from new ships will decay hourly by this value

	DAMAGE_PENALTY_ON_MINIMUM_POSITIONING 							= 0.5, --was 0.5 --damage penalty at 0% positioning
	SCREENING_EFFICIENCY_PENALTY_ON_MINIMUM_POSITIONING				= 0.75, --was 0.5 --screening efficiency (screen to capital ratio) at 0% positioning
	...
	SCREEN_RATIO_FOR_FULL_SCREENING_FOR_CAPITALS 					= 3.0, --was 3.0 --this screen ratio to num capital/carriers is needed for full screening beyond screen line
	SCREEN_RATIO_FOR_FULL_SCREENING_FOR_CONVOYS 					= 0.25, --was 0.5 --this screen ratio to num convoys is needed for full screening beyond screen line
	CAPITAL_RATIO_FOR_FULL_SCREENING_FOR_CARRIERS 					= 0.33, --was 1.0 --this capital ratio to num carriers is needed for full screening beyond screen line
	CAPITAL_RATIO_FOR_FULL_SCREENING_FOR_CONVOYS 					= 0.025, --was 0.25 --this capital ratio to num convoys is needed for full screening beyond screen line
	...
	SUBMARINE_REVEAL_BASE_CHANCE 									= 24, --was 11 --Base factor for submarine detection. It's modified by the difference of a spotter's submarines detection vs submarine visibility. Use this variable for game balancing. setting this too low will cause bad spotting issues.
	...
	SUBMARINE_BASE_TORPEDO_REVEAL_CHANCE 							= 0.18, --was 0.035 --Chance of a submarine being revealed when it fires. 1.0 is 100%. this chance is then multiplied with modifier created by comparing firer's visibiility and target's detection
	...
	NAVAL_COMBAT_AIR_AGILITY_TO_SUB_DETECTION = 0.0, --was 0.0 --Factor to apply to the agility of air planes active in a naval combat to deduce their contibution to sub detection
	NAVAL_COMBAT_AIR_STRIKE_ATTACK_TO_SUB_DETECTION = 0.0, --was 0.0 --Same, but for strike attack (aka naval attack)
	NAVAL_COMBAT_AIR_STRIKE_TARGETING_TO_SUB_DETECTION = 0.0, --was 0.0 --Same, but for strike targeting (aka naval targeting)
	NAVAL_COMBAT_AIR_MAX_SPEED_TO_SUB_DETECTION = 0.0, --was 0.0 --Same, but for Max Speed
	NAVAL_COMBAT_AIR_PLANE_COUNT_TO_SUB_DETECTION = 1.0, --was 1.0 --Factor applied to the number of active plane in a naval combat to deduce their contribution to sub detection
	NAVAL_COMBAT_AIR_SUB_DETECTION_DECAY_RATE = 1.0, --was 1.0 --Factor to decay the value of sub detection contributed by planes on the last hour. Note: the maximum value between the decayed value and the newly computed one is taken into account. A decay rate of 1 means that nothing is carried over, the previous value is zerod out. A decay rate of 0 means that the previous value is carried over as is.
	NAVAL_COMBAT_AIR_SUB_DETECTION_FACTOR = 0.0, --was 0.0 --A global factor that applies after all others, right before the sub detection contributed by plane is added to the global sub detection of a combatant

	NAVAL_COMBAT_AIR_SUB_TARGET_SCORE = 10, --was 10 --scoring for target picking for planes inside naval combat, one define per ship typ
...
NRailwayGun = {
	...
	ATTACK_TO_FORTS_MODIFIER_FACTOR = 0.75,		-- Forts modifier is calculated by multiplying railway gun attack value with this and dividing by 100
	ATTACK_TO_ENTRENCHMENT_MODIFIER_FACTOR = 0.5,		-- Entrenchment modifier is calculated by multiplying railway gun attack value with this and dividing by 100
	...
	DISBAND_MANPOWER_LOSS = 0.0, --was 0.0 --The ration of manpower lost on disbanding railway guns
	ENCIRCLED_DISBAND_MANPOWER_FACTOR = 0.0, --was 0.2 --The percentage of manpower returned when an encircled unit is disbanded
	OUT_OF_SUPPLY_SPEED = -0.1, --was -0.8 --Max speed reduction from supply for railway guns
...
NTrade = {
	DISTANCE_TRADE_FACTOR = -0.01, --was -0.02 --Trade factor is modified by distance times this
	RELATION_TRADE_FACTOR = 0.1, --was 1 --Trade factor is modified by Opinion value times this
	...
	MAX_MONTH_TRADE_FACTOR = 5, --was 50 --This is the maximum bonus that can be gained from time
	BASE_TRADE_FACTOR = 75, --was 150 --This is the base trade factor
	PUPPET_MASTER_TRADE_FACTOR = 400,			-- This is priority for puppet master
	PUPPET_TRADE_FACTOR = 0,					-- This is unpriority for puppets
	BASE_LAND_TRADE_RANGE = 325, --was 1000
...
NAI = {
	...
	BASE_RELUCTANCE = 20, --was 20 --Base reluctance applied to all diplomatic offers
	...
	DIPLOMACY_IMPROVE_RELATION_COST_FACTOR = 7.0, --was 5.0 --Desire to boost relations subtracts the cost multiplied by this
	...
	DIPLOMACY_SEND_MAX_FACTION = 0.75, --was 0.75 --Country should not send away more units than this as expeditionaries
	...
	DIPLOMACY_ACCEPT_ATTACHE_OPINION_TRASHHOLD = 0, --was 20 --Value of opinion that will remove accepting penalty for receiveing the attache
	...
	RESEARCH_NAVAL_DOCTRINE_NEED_GAIN_FACTOR = 0.07, --was 0.05 --Multiplies value based on relative naval industry size / country size.
	RESEARCH_AIR_DOCTRINE_NEED_GAIN_FACTOR = 0.08, --was 0.07 --Multiplies value based on relative number of air base / country size.
	...
	RESEARCH_BONUS_FACTOR = 3, --was 0.9 --To which extent AI should care about bonuses to research
	...
	MAX_AHEAD_RESEARCH_PENALTY = 2, --was 2 --max ahead of tiem penalty ai will pick ever
	RESEARCH_AHEAD_OF_TIME_FACTOR = 1.5, --was 4.0 --To which extent AI should care about ahead of time penalties to research
	RESEARCH_BASE_DAYS = 0, --was 60 --AI adds a base number of days when weighting completion time for techs to ensure it doesn't only research quick techs
	DECLARE_WAR_RELATIVE_FORCE_FACTOR = 0.5,	-- Weight of relative force between nations that consider going to war
	TRADEABLE_FACTORIES_FRACTION = 1, --was 0.8 --Will at most trade away this fraction of factories.
	...
	DEPLOY_MIN_TRAINING_PEACE_FACTOR = 0.99, --was 0.98 --Required percentage of training (1.0 = 100%) for AI to deploy unit in peacetime
	DEPLOY_MIN_EQUIPMENT_PEACE_FACTOR = 0.99, --was 0.98 --Required percentage of equipment (1.0 = 100%) for AI to deploy unit in peacetime
	DEPLOY_MIN_TRAINING_WAR_FACTOR = 0.95, --was 0.95 --Required percentage of training (1.0 = 100%) for AI to deploy unit in wartime
	DEPLOY_MIN_EQUIPMENT_WAR_FACTOR = 0.95, --was 0.95 --Required percentage of equipment (1.0 = 100%) for AI to deploy unit in wartime
	...
	EQUIPMENT_MARKET_MAX_CIVS_FOR_PURCHASES_RATIO = 0.4,            -- Ratio of available civilian factories to max use for equipment purchases (0.2 = 20 %, so 50 available civs would mean max ca 10 civs to spend on purchases at any one time). Gets modified by equipment_market_spend_factories AI strategy.
	EQUIPMENT_MARKET_BASE_MARKET_RATIO = 0.5,                       -- was 0.2 -- The AI tries to keep ca this ratio of equipment surplus for sale on the market. Gets modified by equipment_market_for_sale_factor AI strategy.
	...
	DEFAULT_LEGACY_VARIANT_CREATION_XP_CUTOFF_LAND = 1000, --was 50 --Army XP needed before attempting to create a variant of a type that uses the legacy upgrades system. ai_strategy supports land_xp_spend_priority upgrade_xp_cutoff. If none is set, this define is used instead.
	...
	LENDLEASE_FRACTION_OF_PRODUCTION = 0.5, --was 0.5 --Base fraction AI would send as lendlease
	LENDLEASE_FRACTION_OF_STOCKPILE = 0.5, --was 0.25 --Base fraction AI would send as lendlease
	MINIMUM_EQUIPMENT_TO_ASK_LEND_LEASE = 500, --was -100 --AI will accept to lend lease this equipment only if our stockpile is less than that.
	MINIMUM_CONVOY_TO_ASK_LEND_LEASE = 100, --was 30 --AI will accept to lend lease convoys only if our stockpile is less than that (special case because convoy stockpile can't be negative).
	MINIMUM_FUEL_DAYS_TO_ASK_LEND_LEASE = 30, --was 2 --AI will accept to lend lease fuel only if the player have less fuel than this number multiply by his max daily consumption.
	...
	PLAN_ATTACK_MIN_ORG_FACTOR_LOW = 0.8, --was 0.85 --Minimum org % for a unit to actively attack an enemy unit when executing a plan
	PLAN_ATTACK_MIN_STRENGTH_FACTOR_LOW = 0.9, --was 0.4 --Minimum strength for a unit to actively attack an enemy unit when executing a plan
	PLAN_ATTACK_MIN_ORG_FACTOR_MED = 0.7, --was 0.7 --(LOW,MED,HIGH) corresponds to the plan execution agressiveness level.
	PLAN_ATTACK_MIN_STRENGTH_FACTOR_MED = 0.75, --was 0.3
	PLAN_ATTACK_MIN_ORG_FACTOR_HIGH = 0.4, --was 0.4
	PLAN_ATTACK_MIN_STRENGTH_FACTOR_HIGH = 0.5, --was 0.2
	...
	PLAN_MIN_SIZE_FOR_FALLBACK = 5000, --was 50 --A country with less provinces than this will not draw fallback plans, but rather station their troops along the front
	...
	GENERATE_WARGOAL_THREAT_BASELINE = 0.6, --was 1.0 --The baseline for what the AI considers the world is getting dangerous and we want to generate wargoals with no antagonize value
	...
	RESERVE_TO_COMMITTED_BALANCE = 0.3, --was 0.3 --How many reserves compared to number of committed divisions in a combat (1.0 = as many as reserves as committed)
	...
	MICRO_POCKET_SIZE = 6, --was 4 --Pockets with a size equal to or lower than this will be mocroed by the AI, for efficiency.
	...
	ESTIMATED_CONVOYS_PER_DIVISION = 36, --was 6 --Not always correct, but mainly used to make sure AI does not go crazy
	...
	ORG_UNIT_STRONG = 0.85, --was 0.75 --Organization % for unit to be considered strong
	STR_UNIT_STRONG = 0.86, --was 0.75 --Strength (equipment) % for unit to be considered strong

	ORG_UNIT_WEAK = 0.35, --was 0.15 --Organization % for unit to be considered weak
	STR_UNIT_WEAK = 0.60, --was 0.2 --Strength (equipment) % for unit to be considered weak

	ORG_UNIT_NORMAL = 0.65, --was 0.35 --Organization % for unit to be considered normal
	STR_UNIT_NORMAL = 0.72, --was 0.4 --Strength (equipment) % for unit to be considered normal

	PLAN_FACTION_STRONG_TO_EXECUTE = 0.65, --was 0.50 --% or more of units in an order to consider executing the plan
	PLAN_FACTION_NORMAL_TO_EXECUTE = 0.65, --was 0.65 --% or more of units in an order to consider executing the plan
	PLAN_FACTION_WEAK_TO_ABORT = 0.5, --was 0.65 --% or more of units in an order to consider executing the plan
	PLAN_AVG_PREPARATION_TO_EXECUTE = 0.75, --was 0.5 --% or more average plan preparation before executing
	...
	NEEDED_NAVAL_FACTORIES_EXPENSIVE_SHIP_BONUS = 24, --was 12 --Amount of naval yards you need to get a bonus to building really expensive ships
	...
	DIVISION_DESIGN_MANPOWER_WEIGHT = 0, --was 0.005
	DIVISION_DESIGN_STOCKPILE_WEIGHT = 0, --was 0.01
	DIVISION_DESIGN_COMBAT_WIDTH_WEIGHT = 0, --was -1.0 --This score is reduced the higher width is when comparing pure changes with no target
	DIVISION_DESIGN_COMBAT_WIDTH_TARGET_WEIGHT = 0, --was -200.0 --This score is reduced the farther the width is from the target width (if set)
	...
	UPGRADE_DIVISION_RELUCTANCE = 7, --was 7 --How often to consider upgrading to new templates for units in the field
	UPGRADE_PERCENTAGE_OF_FORCES = 0.1,					-- How big part of the army that should be considered for upgrading

	REFIT_SHIP_RELUCTANCE = 8, --was 28 --How often to consider refitting to new equipment variants for ships in the field
	REFIT_SHIP_PERCENTAGE_OF_FORCES = 0.10, --was 0.1 --How big part of the navy that should be considered for refitting


	NAVY_PREFERED_MAX_SIZE = 25,						-- AI will generally attempt to merge fleets into this size, but as a soft limit.
	INVASION_COASTAL_PROVS_PER_ORDER = 12, --was 24 --AI will consider one extra invasion per number of provinces stated here (num orders = total coast / this)
	...
	REGION_THREAT_LEVEL_TO_AVOID_REGION = 25 * 50, --was 25 * 10 --How much threat must be generated in region ( by REGION_THREAT_PER_SUNK_CONVOY ) so the AI will decide to mark the region as avoid
	REGION_THREAT_LEVEL_TO_BLOCK_REGION = 25 * 500, --was 25 * 100 --How much threat must be generated in region ( by REGION_THREAT_PER_SUNK_CONVOY ) so the AI will decide to mark the region as avoid
	REGION_CONVOY_DANGER_DAILY_DECAY = 4, --was 1 --When convoys are sunk it generates threat in the region which the AI uses to prio nalval missions

	PRODUCTION_LINE_SWITCH_SURPLUS_NEEDED_MODIFIER = 0, --was 0.2 --Is modified by efficency modifiers.
	PLAN_ACTIVATION_MAJOR_WEIGHT_FACTOR = 1, --was 1.5 --AI countries will hold on activating plans if stronger countries have plans in the same location. Majors count extra (value of 1 will negate this)
	PLAN_ACTIVATION_PLAYER_WEIGHT_FACTOR = 1, --was 50.0 --AI countries will hold on activating plans if player controlled countries have plans in the same location.
	...
	MIN_SUPPLY_USE_SANITY_CAP = 60000,					-- Ignore supply cap if below this value when deciding on how many divisions to produce.
	MAX_SUPPLY_DIVISOR = 100.0, --was 1.75 --To make sure the AI does not overdeploy divisions. Higher number means more supply per unit.
	...
	MAX_MICRO_ATTACKS_PER_ORDER = 4, --was 3 --AI goes through its orders and checks if there are situations to take advantage of
	FALLBACK_LOSING_FACTOR = 0.1, --was 1.0 --The lower this number, the longer the AI will hold the line before sending them to the fallback line
	PRODUCTION_MAX_PROGRESS_TO_SWITCH_NAVAL = 0.01, --was 0.1 --AI will not replace ships being built by newer types if progress is above this
	...
	NEW_LEADER_EXTRA_CP_FACTOR = 1, --was 2.0 --Country must have at least this many times extra command power to get new admirals or army leaders
	SCARY_LEVEL_AVERAGE_DEFENSE = -0.7,                 -- average front defense modifier to make it consider it as a PITA to go for
	ATTACK_HEAVILY_DEFENDED_LIMIT = 0.66, --was 0.5 --AI will not launch attacks against heavily defended fronts unless they consider to have this level of advantage (1.0 = 100%)
	HOUR_BAD_COMBAT_REEVALUATE = 12, --was 100 --if we are in combat for this amount and it goes shitty then try skipping it
	...
	MAX_UNITS_FACTOR_FRONT_ORDER = 1.0, --was 1.0 --Factor for max number of units to assign to area front orders
	DESIRED_UNITS_FACTOR_FRONT_ORDER = 1.1, --was 1.1 --Factor for desired number of units to assign to area front orders
	MIN_UNITS_FACTOR_FRONT_ORDER = 0.75, --was 1.0 --Factor for min number of units to assign to area front orders
	...
	MIN_FIELD_STRENGTH_TO_BUILD_UNITS = 0.01, --was 0.7 --Cancel unit production if below this to get resources out to units in the field
	MIN_MANPOWER_TO_BUILD_UNITS = 0.01, --was 0.7 --Cancel unit production if below this to get resources out to units in the field
	...
	INVASION_DISTANCE_RANDOMNESS = 300, --was 300 --This higher the value, the more unpredictable the invasions. Compares to actual map distance in pixels.


	AIR_SCORE_DISTANCE_IMPACT = 0.25, --was 0.3 --Effect of distance applied to the score calculations
	DAYS_BETWEEN_AIR_PRIORITIES_UPDATE = 6, --was 4 --Amount of days between air ai updates priorities for air wings ( from 1 to N )

	NAVAL_AIR_SUPERIORITY_IMPORTANCE = 0.1, --was 0.10 --Strategic importance of air superiority ( amount of enemy planes in area )
	NAVAL_SHIP_AIR_IMPORTANCE = 2, --was 2.0 --Naval ship air importance
	NAVAL_SHIP_IN_PORT_AIR_IMPORTANCE = 6, --was 6.0 --Naval ship in the port air importance
	NAVAL_COMBAT_AIR_IMPORTANCE = 12, --was 8.0 --Naval combat air importance
	NAVAL_TRANSFER_AIR_IMPORTANCE = 0, --was 0.0 --Naval transfer air importance
	NAVAL_COMBAT_TRANSFER_AIR_IMPORTANCE = 50, --was 50.0 --Naval combat involving enemy land units
	NAVAL_IMPORTANCE_SCALE = 0.8, --was 0.65 --Naval total importance scale (every naval score get's multiplied by it)
	...
	NAVAL_STRIKE_PLANES_PER_SHIP = 20, --was 20 --Amount of bombers requested per enemy ship
	PORT_STRIKE_PLANES_PER_SHIP = 10, --was 10 --Amount of bombers request per enemy ship in the port
	...
	LAND_DEFENSE_MIN_FACTORIES_FOR_AIR_IMPORTANCE = 30, --was 5 --If amount of factories is less importance of factories won't apply

	LAND_DEFENSE_FIGHERS_PER_PLANE = 1, --was 1.8 --Amount of air superiority planes requested per enemy plane
	LAND_DEFENSE_INTERSEPTORS_PER_BOMBERS = 1.2, --was 0.8 --Amount of air interceptor planes requested per enemy bomber
	LAND_DEFENSE_INTERSEPTORS_PER_PLANE = 1, --was 0.1 --Amount of air interceptor planes requested per enemy plane (non bomber)
	...
	LAND_COMBAT_ENEMY_LAND_FORTS_AIR_IMPORTANCE = 5, --was 5 --Strategic importance of enemy land forts in the region
	LAND_COMBAT_ENEMY_COASTAL_FORTS_AIR_IMPORTANCE = 5, --was 3 --Strategic importance of enemy coastal fronts in the region
	LAND_COMBAT_IMPORTANCE_SCALE = 1.5, --was 5.0 --Lend combat total importance scale (every land combat score get's multiplied by it)

	LAND_COMBAT_FIGHTERS_PER_PLANE = 1.1, --was 1.0 --Amount of air superiority planes requested per enemy plane
	LAND_COMBAT_CAS_PLANES_PER_ENEMY_ARMY_LIMIT = 200,	-- Limit of CAS planes requested by enemy armies
	LAND_COMBAT_CAS_PER_ENEMY_ARMY = 40, --was 30 --Amount of CAS planes requested per enemy division
	...
	XP_RATIO_REQUIRED_TO_RESEARCH_WITH_XP = 3.0, --was 2.0 --AI will at least need this amount of xp compared to cost of a tech to reserch it with XP
	RESEARCH_WITH_XP_AI_WEIGHT_MULT = 1.5, --was 1.2 --AI will bump score of a research with this mult if it can use XP

	STR_BOMB_AIR_SUPERIORITY_IMPORTANCE = 0.1, --was 0.10 --Strategic importance of air superiority ( amount of enemy planes in area )
	STR_BOMB_CIVIL_FACTORY_IMPORTANCE = 25, --was 50 --Strategic importance of enemy civil factories
	STR_BOMB_MILITARY_FACTORY_IMPORTANCE = 60, --was 70 --Strategic importance of enemy military factories
	STR_BOMB_NAVAL_FACTORY_IMPORTANCE = 50, --was 30 --Strategic importance of enemy naval factories
	STR_BOMB_SUPPLY_HUB_IMPORTANCE = 1,                 -- Strategic importance of enemy supply hubs
	STR_BOMB_AA_IMPORTANCE_FACTOR = 0.5, --was 0.5 --Factor of AA influence on strategic importance ( 0.0 - 1.0 )
	STR_BOMB_INFRA_IMPORTANCE_FACTOR = 0.25, --was 0.25 --Factor of infrastructure influence on strategic importance ( 0.0 - 1.0 )
	STR_BOMB_IMPORTANCE_SCALE = 1.0, --was 1.0 --str bombing total importance scale (every str bombing score get's multiplied by it)

	STR_BOMB_MIN_ENEMY_FIGHTERS_IN_AREA = 5000, --was 2000 --If amount of enemy fighters is higher than this mission won't perform
	STR_BOMB_FIGHTERS_PER_PLANE = 1, --was 1.1 --Amount of air superiority planes requested per enemy plane
	STR_BOMB_PLANES_PER_CIV_FACTORY = 10, --was 20 --Amount of planes requested per enemy civ factory
	STR_BOMB_PLANES_PER_MIL_FACTORY = 15, --was 25 --Amount of planes requested per enemy military factory
	STR_BOMB_PLANES_PER_NAV_FACTORY = 15, --was 15 --Amount of planes requested per enemy naval factory
	STR_BOMB_PLANES_PER_SUPPLY_HUB = 3,                 -- Amount of planes requested per enemy supply node
	STR_BOMB_MIN_EXCORT_PLANES = 200, --was 200 --Min amount of planes requested to excort operations
	...
	MAX_CARRIER_OVERFILL = 1.50, --was 1.85 --Carriers will be overfilled to this amount if there are doctrines to justify it
	...
	DOCKYARDS_PER_NAVAL_DESIRE_EFFECT = 0, --was -20.0 --Effects how much AI wants to build dockyards based on how navally focused they are in general. Recommended range -100.0 to 100.0.
	...
	DEPLOYED_UNIT_MANPOWER_RATIO_TO_BUFFER_PEACETIME = 0.1, --was 0.1 --deployment will try to buffer a ratio of deployed manpower (for reinforcements) during peace time

	MAX_AVAILABLE_MANPOWER_RATIO_TO_BUFFER_WARTIME = 0.2, --was 0.4 --deployment will try to buffer a ratio of manpower (for reinforcements) during war time
	MAX_AVAILABLE_MANPOWER_RATIO_TO_BUFFER_PEACETIME = 0.1, --was 0.2 --deployment will try to buffer a ratio of manpower (for reinforcements) during peace time

	MANPOWER_RATIO_REQUIRED_TO_PRIO_MOBILIZATION_LAW = 0.4, --was 0.4 --percentage of manpower in field is desired to be buffered for AI when it has upcoming wars or already at war. if it has less manpower, it will prio manpower laws
	UPGRADES_DEFICIT_LIMIT_DAYS = 180, --was 50 --Ai will avoid upgrading units in the field to new templates if it takes longer than this to fullfill their equipment need
	...
	CARRIER_TASKFORCE_MAX_CARRIER_COUNT = 4, --was 4 --optimum carrier count for carrier taskforces
	CAPITAL_TASKFORCE_MAX_CAPITAL_COUNT = 6, --was 12 --optimum capital count for capital taskforces
	SCREEN_TASKFORCE_MAX_SHIP_COUNT = 16, --was 12 --optimum screen count for screen taskforces
	SUB_TASKFORCE_MAX_SHIP_COUNT = 8, --was 16 --optimum sub count for sub taskforces

	MIN_CAPITALS_FOR_CARRIER_TASKFORCE = 4, --was 6 --carrier fleets will at least have this amount of capitals
	CAPITALS_TO_CARRIER_RATIO = 1.5, --was 1.5 --capital to carrier count in carrier taskfoces
	SCREENS_TO_CAPITAL_RATIO = 3.0, --was 4.0 --screens to capital/carrier count in carrier & capital taskforces
	...
	MAX_SCREEN_TASKFORCES_FOR_CONVOY_DEFENSE_MIN = 0.50, --was 0.20 --maximum ratio of all screen-ships forces to be used in convoy defense (increases up to max as AI loses convoys).
	MAX_SCREEN_TASKFORCES_FOR_CONVOY_DEFENSE_MAX = 0.90, --was 0.70 --maximum ratio of all screen-ships forces to be used in convoy defense (increases up to max as AI loses convoys).
	MAX_SCREEN_TASKFORCES_FOR_CONVOY_DEFENSE_MIN_CONVOY_THREAT = 50, --was 100 --AI will increase screen assignment for escort missions as threate increases
	...
	MAX_SCREEN_TASKFORCES_FOR_MINE_SWEEPING = 0.10, --was 0.15 --maximum ratio of screens forces to be used in mine sweeping
	...
	MAX_SCREEN_TASKFORCES_FOR_MINE_SWEEPING_PRIO_MAX_MINES = 250, --was 1000 --highest mines for highest prio for mine missions


	MAX_SCREEN_TASKFORCES_FOR_MINE_LAYING = 0.05, --was 0.15 --maximum ratio of screens forces to be used in mine laying
	...
	MAX_FACTORY_TO_SPARE_FOR_MISSION_FUEL_TRADE = 0.33, --was 0.12 --amount of factories to spend on oil trade in case of fuel need for missions
	MAX_FACTORY_TO_SPARE_FOR_CRITICAL_MISSION_FUEL_TRADE = 0.66, --was 0.3 --amount of factories to spend on oil trade in case of fuel need for prio missions
	MAX_FACTORY_TO_TRADE_FOR_FUEL = 0.66, --was 0.5
	FUEL_TRADE_PRIO_FOR_CONVOY_DEFENSE = 0.3,								-- AI will be less reluctant to cancel convoy missions if it is trading for oil

	MAX_FACTORY_TO_SPARE_FOR_MISSION_FUEL_TRADE_IN_PEACE = 0.33, --was 0.03 --amount of factories to spend on oil trade in case of fuel need for missions in peace time
	MAX_FACTORY_TO_SPARE_FOR_CRITICAL_MISSION_FUEL_TRADE_IN_PEACE = 0.66, --was 0.1 --amount of factories to spend on oil trade in case of fuel need for prio missions in peace time
	MAX_FACTORY_TO_TRADE_FOR_FUEL_IN_PEACE = 0.66, --was 0.15
	...
	FUEL_RATIO_TO_EXIST_FUEL_SAVING_MODE = 0.40, --was 0.60 --countries will exit fuel saving mode if they have more fuel ratio than this




	WANTED_MAX_FUEL_BUFFER_IN_DAYS_FOR_ARMY_MAX_CONSUMPTION = 365, --was 60 --AI will try to buffer at least this amount of days on max consumption, will trade if necesarry and will go into fuel saving mode/aggresive mode using this buffer
	WANTED_MAX_FUEL_BUFFER_IN_DAYS_FOR_AIR_MAX_CONSUMPTION  = 365, --was 60 --AI will try to buffer at least this amount of days on max consumption, will trade if necesarry and will go into fuel saving mode/aggresive mode using this buffer
	WANTED_MAX_FUEL_BUFFER_IN_DAYS_FOR_NAVY_MAX_CONSUMPTION = 365, --was 60 --AI will try to buffer at least this amount of days on max consumption, will trade if necesarry and will go into fuel saving mode/aggresive mode using this buffer
	...
	MAX_FUEL_CONSUMPTION_RATIO_FOR_NAVY_TRAINING = 0.1, --was 0.20 --ai will use at most this ratio of affordable fuel for naval training

	MAX_FULLY_TRAINED_SHIP_RATIO_FOR_TRAINING = 1.0, --was 0.7 --ai will not train a taskforce if fully trained ships are above this ratio
	...
	PRODUCTION_CARRIER_PLANE_BUFFER_RATIO = 2.0, --was 1.5 --in addition to total deck size of carriers, we want at least this ratio to buffer it
	...
	AIR_AI_ENEMY_PROV_RATIO_FOR_COMBAT_REGION = 0.05, --was 0.15 --if a region has more than this ratio of provinces controlled by enemy, AI will consider it as a combat zone while assigning planes

	RESEARCH_MULTI_DOCTRINE_SCORE = 0.1, --was 0.3 --score penalty to researchign multiple doctrines at once for AI
	CONVOY_ESCORT_SCORE_FROM_CONVOYS = 15,                       -- score for each convoy you have in area
	CONVOY_ESCORT_MUL_FROM_NO_CONVOYS = 0, --was 0.02 --score multiplier when no convoys are around
	...
	MAX_INVASION_SIZE = 18, --was 24 --max invasion group size
	...
	FIX_SUPPLY_BOTTLENECK_SATURATION_THRESHOLD = 1.25, --was 0.85; --Try to fix supply bottlenecks if supply node saturation exceeds this value.
	...
	DIVISION_SUPPLY_RATIO_TO_MOTORIZE = 0.95,				--was 0.80		-- If supply ratio is less than this, consider motorizing any applicable nearby supply hub
...
NFocus = {
	...
	MAX_SAVED_FOCUS_PROGRESS = 14, --was 10 --This much progress can be saved while not having a focus selected
},

NOperatives = {
	AGENCY_CREATION_DAYS = 400, --was 30 --Number of days needed to create an intelligence agency
	AGENCY_UPGRADE_DAYS = 400, --was 30 --Number of days needed to upgrade an intelligence agency
	...
	MAX_OPERATIVE_SLOT_FROM_AGENCY_UPGRADES = 5, --was 1 --max operative slots gained from upgrades
	...
	AGENCY_DEFENSE_EFFECT_ON_HOSTILE_ACTION_COST = 0.15, --was 0.2 --Defense factor that is responsible for multiplying the cost hostile actions against our country by its level and this value
	...
	INTEL_NETWORK_MIN_VP_TO_TARGET = 1, --was 15 --The minimum value of the highest VP in a state to consider the state as a valid target to start building an intel network
	...
	ROOT_OUT_RESISTANCE_DAILY_XP_GAIN = 0.112,
...
NIntel = {
	...
	STATIC_INTEL_SOURCE_BROKEN_CYPHER_MAXIMUMS = { 65.0, 65.0, 65.0, 65.0 }, --was { 60.0 60.0 60.0 60.0 }
	STATIC_INTEL_SOURCE_RADAR_MAXIMUMS = { 10.0, 10.0, 20.0, 20.0 }, --was { 10.0 10.0 20.0 20.0 }
	STATIC_INTEL_SOURCE_INTEL_NETWORK_MAXIMUMS = { 25.0, 25.0, 33.0, 25.0}, --was { 30.0 30.0 40.0 30.0}
	...
	ARMY_INTEL_COMBAT_BONUS_MAX_BONUS = 0.1, --was 0.15 --max combat bonus that will apply when intel is high enough
	ARMY_INTEL_COMBAT_BONUS_FACTOR_ATTACK = 0.5, --was 1.0 --multiplier for attack value of intel combat bonus
...
NCharacter = {
	...
	DEFAULT_PP_COST_FOR_POLITICAL_ADVISOR = 100, --was 150
...
NSupply = {
	...
	CAPITAL_SUPPLY_BASE = 225.0, --was 5.0 --base supply for capital
	CAPITAL_SUPPLY_CIVILIAN_FACTORIES = 4.50, --was 0.3 --supply from one civilian factory
	CAPITAL_SUPPLY_MILITARY_FACTORIES = 9.00, --was 0.6 --supply from one military factory
	CAPITAL_SUPPLY_DOCKYARDS = 4.50, --was 0.4 --supply from one naval factory
	...
	CAPITAL_INITIAL_SUPPLY_FLOW = 1800.0, --was 5.0 --starting supply from
	CAPITAL_STARTING_PENALTY_PER_PROVINCE = 345.0, --was 0.5 --starting penalty that will be added as supply moves away from its origin (modified by stuff like terrain)
	CAPITAL_ADDED_PENALTY_PER_PROVINCE = 90.0, --was 1.2 --added penalty as we move away from origin

	-- defines that are used for supply reach for built nodes
	NODE_INITIAL_SUPPLY_FLOW = 1200.0, --was 2.8
	NODE_STARTING_PENALTY_PER_PROVINCE = 345.0, --was 0.50
	NODE_ADDED_PENALTY_PER_PROVINCE = 90.0, --was 0.70

	-- defines that are used for supply reach for dockyards
	NAVAL_BASE_INITIAL_SUPPLY_FLOW = 1200.0, --was 3.3
	NAVAL_BASE_STARTING_PENALTY_PER_PROVINCE = 345.0, --was 0.84
	NAVAL_BASE_ADDED_PENALTY_PER_PROVINCE = 90.0, --was 1.1
	...
	FLOATING_HARBOR_STARTING_PENALTY_PER_PROVINCE = 345.0,
	FLOATING_HARBOR_ADDED_PENALTY_PER_PROVINCE = 90.0,

	FLOATING_HARBOR_BASE_SUPPLY = 600.0, -- supply given by a floating harbor
	...
	SUPPLY_FLOW_PENALTY_CROSSING_RIVERS = 120.00, --was 0.20 --crossing rivers introduces additional penalty
	...
	SUPPLY_HUB_FULL_MOTORIZATION_BONUS = 1200.0,
	...
	VP_TO_SUPPLY_BONUS_CONVERSION = 1.50, --was 0.05 --Bonus to supply local supplies from Victory Points, multiplied by this aspect and rounded to closest integer
	SUPPLY_FROM_DAMAGED_INFRA = 2.00, --was 0.15 --damaged infrastructure counts as this in supply calcs
	SUPPLY_BASE_MULT = 0.0, --was 0.2 --multiplier on supply base values
	SUPPLY_DISRUPTION_DAILY_RECOVERY = 120.0,		-- every day nodes recover this much of their accumulated disruption.
	...
	RAILWAY_CONVERSION_COOLDOWN_CIVILWAR = 1, --was 0
	...
	TRUCK_ATTRITION = 0.003, --was 0.003 --base truck attrition
	TRUCK_ATTRITION_FACTOR = 0.45, --was 0.65 --a scale on total truck attrition

	BASE_TRUCK_HP = 100.0,
	TRUCK_HP_PER_ARMOR = 2,

	BASE_TRAIN_HP = 100.0, --was 100.0
	...
	SUPPLY_FLOW_REDUCTION_THRESHOLD = 12.00, --was 0.1 --if supply flow is lower than this, it is not applied
	...
	ARMY_SUPPLY_RATIO_STARTING_GAIN = 0.1,
	ARMY_SUPPLY_RATIO_SPEED_GAIN_PER_HOUR = 0.04, --was 0.01
	ARMY_MAX_SUPPLY_RATIO_GAIN_PER_HOUR = 1, --was 0.15
	...
	DAYS_TO_START_GIVING_SUPPLY_AFTER_MOVING_SUPPLY_CAPITAL = 4, --was 7 --the country will start gaining supply after this many days moving its capital
	...
	SUPPLY_PATH_MAX_DISTANCE = 24, --was 15 --max time it can take
	...
	ALERT_VERY_LOW_SUPPLY_LEVEL = 0.50, --was 0.2 --At which point we show up the low and very low supply level alert. Value is in % of supplies supported vs required.
	...
	AI_FRONT_DIVISIONS_PER_SUPPLY_POINT = 0.02, -- How many divisions should the AI consider it can supply per available supply point
	...
	AVAILABLE_MANPOWER_STATE_SUPPLY = 4.50, --was 0.18 --Factor for state supply from max manpower (population)
	NON_CORE_MANPOWER_STATE_SUPPLY = 15.0,						--Factor for population sttate supply when controlled by an occupier (NO TAKE FOOD)
...
NIndustrialOrganisation = {
	...
	FUNDS_FOR_SIZE_UP = 150,									-- Funds needed for a MIO to increment its size and get points to unlock traits
	FUNDS_FOR_SIZE_UP_LEVEL_FACTOR = 18, 						-- How much each level mutliplies the funds for size up 
	...
	FUNDS_FOR_RESEARCH_COMPLETION_PER_RESEARCH_COST = 80,     	-- Funds added to MIO when the Design Team has completed a research, multiplied by research_cost in technology template
	...
	DEFAULT_INITIAL_TASK_CAPACITY = 1,							-- Default start task capacity for each MIO (may be overriden in DB)
